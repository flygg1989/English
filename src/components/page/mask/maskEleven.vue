    ...
    <div class="mask maskone">
         <el-dialog :title="formdata.title" :visible.sync="editVisible" :close-on-click-modal="false" width="864px">
            <el-form ref="formdata" :model="formdata">
                ...
                <div class="mask_tip mask_tip_color_one" v-if="formdata.plat_status == 2">{{this.formdata.status_name}}</div>
                <div class="mask_tip mask_tip_color_one" v-if="formdata.plat_status == 3">{{this.formdata.status_name}}</div>
                <div class="mask_tip mask_tip_color_one" v-if="formdata.plat_status == 4">{{this.formdata.status_name}}</div>
                <div class="mask_tip mask_tip_color_one" v-if="formdata.plat_status == 5">{{this.formdata.status_name}}</div>
                <div class="mask_tip mask_tip_color_one" v-if="formdata.plat_status == 6">{{this.formdata.status_name}}</div>
                ...
                <div class="mask_tip mask_tip_color_one" v-if="formdata.plat_status == 9">{{this.formdata.status_name}}</div>
                <div class="mask_tip mask_tip_color_one" v-if="formdata.plat_status == 10">{{this.formdata.status_name}}</div>
                <div class="mask_tip mask_tip_color_two" v-if="formdata.plat_status == 11">{{this.formdata.status_name}}</div>
                <div class="mask_tip mask_tip_color_two" v-if="formdata.plat_status == 12">{{this.formdata.status_name}}</div>
                ...
                <div class="bg_color_f7" v-if="formdata.chase_list !=null ">
                        ...
                        <div v-for="(item,index) in formdata.reply_list" :key="index">
                            ...
                            <el-input type="textarea" readonly autosize v-model="item.reply" placeholder=""></el-input>
                        </div>
                    ...
                    <div v-if="formdata.chase_list != null">
                        ...
                        <el-input type="textarea" readonly autosize v-model="formdata.content" placeholder=""></el-input>
                    </div>
                </div>
                ...
                <div v-if="formdata.chase_list && formdata.chase_list !=null">
                    <div v-for="(item,index) in formdata.chase_list.reply_list" :key="index" >
                        ...
                        <el-input type="textarea" :readonly="isReadOnlyOne" autosize  v-model="item.remark" placeholder="建议将该问题对外隐藏！"></el-input>
                    </div>
                </div>
