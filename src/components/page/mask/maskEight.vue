<template>
    <div class="mask maskone">
         <el-dialog :title="formdata.title" :visible.sync="editVisible" :close-on-click-modal="false" width="864px">
            <el-form ref="formdata" :model="formdata">
                ...
                <div class="bg_color_f7">
                    ...
                    <div v-for="(item,index) in formdata.reply_list" :key="index">
                        ...
                        <el-input type="textarea" readonly readonly v-model="formdata.chase_list.content" placeholder=""></el-input>
                    </div>
                </div>
                ...
                <div v-for="(item,index) in formdata.reply_list" :key="index">
                    ...
                    <el-upload
                        ...
                        v-if="buttononestate == 2 && item.attachments.length < 6" class="uploadImg_nolist"> 
                    ...
                    <el-input type="textarea" autosize  readonly v-model="item.remark" placeholder="建议将该问题对外隐藏！"></el-input>
                </div>
            ...
            <span slot="footer" class="dialog-footer">
                <el-button type="primary" @click="saveEdit">办结问题</el-button>
            </span>
        </el-dialog>
