         ...
         <el-dialog :title="formdata.title" :visible.sync="editVisible" :close-on-click-modal="false" width="864px">
            <el-form ref="formdata" :model="formdata">
                ...
                <div v-else>
                    ...
                    <el-input type="textarea" readonly autosize v-model="formdata.chase_list.content" placeholder=""></el-input>
                ...
                <div v-if="formdata.chase_list == null">
                    <div v-for="(item,index) in formdata.reply_list" :key="index" >
                        ...
                        <el-input type="textarea" readonly autosize v-model="item.remark" placeholder="建议将该问题对外隐藏！"></el-input>
                    </div>
                </div>
