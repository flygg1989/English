  ...
  <div class="tabs-content" v-loading="isLoad">
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div class="table2-2">
            <el-button @click="evaluateOne(scope.row)" plain size="mini" type="primary">默认好评</el-button>
            <el-switch
    ...
    <div class="table-footer">
      <div class="footer-left">
        ...
        <el-button plain type="primary" @click="evaluateAll">默认好评</el-button>
