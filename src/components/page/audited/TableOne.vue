  ...
  <div class="tabs-content" v-loading="isLoad">
    <el-table
      ...
      <el-table-column
        ...
        width="96">
        <template slot-scope="scope">
          <el-button @click="withdrawOne(scope.row)" plain size="mini" type="primary">撤回</el-button>
    ...
    <div class="table-footer">
      <div class="footer-left">
        ...
        <el-button plain type="primary" @click="withdrawAll">撤回</el-button>
