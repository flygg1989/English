  ...
  <div class="tabs-content" v-loading="isLoad">
    <el-table
      ...
      <el-table-column
        ...
        width="128">
        <template slot-scope="scope">
          <el-button @click="finishOne(scope.row)" plain size="mini" type="primary">手动办结</el-button>
    ...
    <div class="table-footer">
      <div class="footer-left">
        ...
        <el-button plain type="primary" @click="finishAll">手动办结</el-button>
